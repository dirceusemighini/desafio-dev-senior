...
object FaultcodeEnum {
  def fromString(value: String, scope: scala.xml.NamespaceBinding): FaultcodeEnum = ({
...
case object U123httpu58u47u47wwwu46w3u46orgu472003u4705u47soapu45envelopeu125DataEncodingUnknown extends FaultcodeEnum {
  override def toString = "{http://www.w3.org/2003/05/soap-envelope}DataEncodingUnknown"
}

case object U123httpu58u47u47wwwu46w3u46orgu472003u4705u47soapu45envelopeu125MustUnderstand extends FaultcodeEnum {
  override def toString = "{http://www.w3.org/2003/05/soap-envelope}MustUnderstand"
}

case object U123httpu58u47u47wwwu46w3u46orgu472003u4705u47soapu45envelopeu125Receiver extends FaultcodeEnum {
  override def toString = "{http://www.w3.org/2003/05/soap-envelope}Receiver"
}

case object U123httpu58u47u47wwwu46w3u46orgu472003u4705u47soapu45envelopeu125Sender extends FaultcodeEnum {
  override def toString = "{http://www.w3.org/2003/05/soap-envelope}Sender"
}

case object U123httpu58u47u47wwwu46w3u46orgu472003u4705u47soapu45envelopeu125VersionMismatch extends FaultcodeEnum {
  override def toString = "{http://www.w3.org/2003/05/soap-envelope}VersionMismatch"
}
